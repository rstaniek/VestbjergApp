...
public enum ErrorCode {
    ...
    VALIDATION_FIELD_EMPTY("Input ERROR", "All fields must be filled properly", Alert.AlertType.ERROR),
    VALIDATION_ILLEGAL_CHARS("Input ERROR", "Illegal characters spotted in th input", Alert.AlertType.ERROR),
    ...
    USER_ALREADY_LOGGED_OUT("Warning", "You are already logged out", Alert.AlertType.INFORMATION),
    DATABASE_UPLOAD_ERROR("Upload ERROR", "Couldn't upload changes to the database!", Alert.AlertType.ERROR),
    WAREHOUSE_LOW_AMOUNT_OF_PRODUCT("WARNING", "Low supply of the current product. Please consider restocking the supplies", Alert.AlertType.WARNING),
    TEXT_FIELD_NON_NUMERIC("ERROR", "Illegal, non numeric characters detected in the text field!", Alert.AlertType.ERROR),
